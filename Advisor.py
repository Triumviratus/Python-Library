...
class Generic_Major:
    ...
    def major_advising(self):
        if self.major_troubles:
            print("because you are having trouble with your major:")
            self.print_advising()

    def print_advising(self):
    ...
    def math_advising(self):
        if self.math_troubles:
            print("because you are having trouble with math:")
...
class CLS_Major(Generic_Major):
    ...
    def __init__(self, first_name, last_name):
        ...
        Generic_Major.__init__(self, first_name, last_name)
...
class COE_Major(Generic_Major):
    ...
    def print_advising(self):
        ...
        Generic_Major.print_advising(self)
        
class Computer_Engineering_Major(COE_Major):

    def __init__(self, first_name, last_name):
        
        COE_Major.__init__(self, first_name, last_name)
...
class Physics_Major(CLS_Major):
    ...
    def __init__(self, first_name, last_name):
        ...
        CLS_Major.__init__(self, first_name, last_name)
        self.major = "Physics"

    def print_advising(self):
        print("--> visit the Physics Learning Center in Barnard Hall 230")
        CLS_Major.print_advising(self)
...
# This Class holds Generic information to be tested and printed.
...
# These are all the Sub-Classes to test and print for selected Majors.
